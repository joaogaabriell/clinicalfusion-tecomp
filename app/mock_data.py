...
PACIENTES = {
    "patient_0001": {
        ...
        "ecg": {"fc": 102, "ritmo": "Sinusal taquicárdico", "seed": 11,
                "obs": "Alterações discretas de repolarização em derivações anteriores (dado fictício)."},
        "xray": {"seed": 11, "cardiomegalia": True, "consolidacao": None,
                 "impressao": "Índice cardiotorácico no limite superior da normalidade; campos pulmonares sem consolidações (dado fictício)."},
        "lab": [
    ...
    "patient_0002": {
        ...
        "ecg": {"fc": 96, "ritmo": "Sinusal", "seed": 22,
                "obs": "Traçado sem alterações significativas (dado fictício)."},
        "xray": {"seed": 22, "cardiomegalia": False, "consolidacao": (0.31, 0.58),
                 "impressao": "Opacidade heterogênea em base pulmonar direita, compatível com processo consolidativo (dado fictício)."},
        "lab": [
    ...
    "patient_0003": {
        ...
        "ecg": {"fc": 118, "ritmo": "Fibrilação atrial (RR irregular)", "seed": 33,
                "obs": "Resposta ventricular elevada, ausência de onda P (dado fictício)."},
        "xray": {"seed": 33, "cardiomegalia": True, "consolidacao": (0.66, 0.52),
                 "impressao": "Cardiomegalia importante com sinais de congestão pulmonar e opacidade perihilar (dado fictício)."},
        "lab": [
            ("BNP", "1.450", "pg/mL", "< 100", "↑"),
